...
import { useProcurador, STEP_META, stepTitles, stepSubtitles } from '../hooks/useProcurador.ts'

export function RegistrarProcurador() {
  const {
    step, setStep,
    cnpj, setCnpj,
    codigo, setCodigo,
  ...
  } = useProcurador('registro_procurador', "Já existe uma conta cadastrada com esse CPF. Tente fazer login.");
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-gray-200 px-4 py-10">
      <Link
        to="/"
        className="fixed left-4 top-4 flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-lg font-bold text-gray-600 shadow-sm transition hover:border-green-200 hover:bg-green-50 hover:text-green-700"
      >
        <Home size={18} />
        Início
      </Link>
      <div className="w-full max-w-md">
        <div className="mb-6 text-center">
          <h1 className="text-3xl font-bold text-gray-800">Crie sua conta de procurador</h1>
