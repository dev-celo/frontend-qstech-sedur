    ...
    >
      <nav
        className={`transition-all duration-500 ${
          isScrolled
            ? 'bg-white/80 backdrop-blur-xl shadow-lg rounded-full px-6 py-3'
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <div className="relative">
              <div className="absolute inset-0 bg-[#27ae60] rounded-lg blur opacity-20 group-hover:opacity-40 transition-opacity" />
              <div className="relative bg-gradient-to-br from-[#27ae60] to-[#1e8449] p-2 rounded-lg">
