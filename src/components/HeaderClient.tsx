import { Building2, IdCard, LogOut, Mail, Phone } from "lucide-react";
  ...
  return (
    <div className="mb-6">
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <p className="mt-1 text-center text-sm text-gray-600">
            Acompanhe seus processos e tramitações
          </p>
        </div>
      ...
      <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <h2 className="text-sm font-bold text-gray-800">Dados da empresa</h2>
        ...
        <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:justify-between">
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800">{empresa}</p>
            </div>
          </div>
